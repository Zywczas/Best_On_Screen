...
class MovieDetailsVM (private val repo: MovieRepository) : ViewModel(){
    ...
    fun addMovieToDb (movie: Movie) = repo.addMovieToDB(movie)
...
//    fun getMovie(movieId: Int, context: Context) = repo.getMovieFromDB(movieId, context) as LiveData<Movie>
    ...
    fun deleteMovieFromDb(movie: Movie) = repo.deleteMovieFromDB(movie)

//    private val mObservableMessage: LiveData<String>
